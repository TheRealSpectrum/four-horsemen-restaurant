<x-popup {{$attributes}} data-form-id="{{$formId}}" class="confirmation justify-center place-items-center bg-dim hidden" internalClass="bg-light flex flex-col max-w-xl">
