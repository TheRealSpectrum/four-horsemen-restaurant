...
@endphp
<div data-show-box-index="{{$id}}" class="show-box-trigger border-black border grid grid-cols-2 grid-rows-3 h-16 p-2 text-sm reservation relative bg-light dark:bg-dark">
